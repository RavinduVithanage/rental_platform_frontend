  ...
  return (
    <div className="relative py-24 overflow-hidden bg-[#0a0a0f]">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(to bottom, rgba(10,10,15,0.8), rgba(10,10,15,0.95)), url("https://images.unsplash.com/photo-1571115764595-644a1f56a55c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80")'
        }}
      ></div>

      {/* Background orbs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-violet-600/20 rounded-full blur-3xl" />
